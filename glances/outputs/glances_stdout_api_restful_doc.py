...
def print_all():
    ...
    print('')
    print('Get all Glances stats encoded with MessagePack::')
    print('')
    print(f'    # curl {API_URL}/all/msgpack --output glances.msgpack')
    print('    Return the same dictionary encoded as application/msgpack')
    print('')
