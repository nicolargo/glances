...
class Plugin(GlancesPlugin):
    ...
    def generate_view_data(self):
        ...
        self.view_data['sort_mem']                          = msg_col.format("m", _("Sort processes by MEM%"))
        self.view_data['sort_user']                         = msg_col.format("u", _("Sort processes by USER"))
        ...
        self.view_data['sort_cpu_times']                    = msg_col.format("t", _("Sort processes by TIME"))
        ...
        self.view_data['enable_disable_docker']             = msg_col2.format("D", _("Enable/disable Docker stats"))
        self.view_data['enable_disable_quick_look']         = msg_col.format("3", _("Enable/disable quick look plugin"))
