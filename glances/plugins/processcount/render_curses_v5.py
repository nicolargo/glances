...
- The v4 sort indicator (``sorted by cpu_percent``, ``Programs``/``Threads``)
  is dropped for G4 — sort is hardcoded to ``cpu_percent`` (engine default)
  and will be re-introduced when v5 wires sort-key configuration through.
"""
