...
| Python API (`from glances import api`, `glances/api.py`) | `glances/api.py`, documented by v4's `--api-doc` into `docs/api/python.rst` | No v5 equivalent. Found while deciding `--api-doc` (2026-09-26). | **Decided (maintainer, 2026-09-26): port to v5.** Its own design first: what the v5 API wraps (the store, the plugins, one-shot collection), and how its documentation is generated now that `--api-doc` means Swagger. |
