...
| Python API (`from glances import api`, `glances/api.py`) | `glances/api.py`, documented by v4's `--api-doc` into `docs/api/python.rst` | No v5 equivalent. Found while deciding `--api-doc` (2026-09-26). | Needs a maintainer decision: port, redesign, or drop. |
